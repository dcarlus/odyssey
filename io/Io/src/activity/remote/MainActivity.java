...
public class MainActivity extends DefaultActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		File securityData = new File(getFilesDir(), securityDataFilename);
		File counter_IO = new File(getFilesDir(),counterIoFilename);
		initUI(false);
		...
		if (intent != null)
		{
			...
			st = new Servertask(new MainActivityHandler(this), ip, port,
	...
	{
		if (!led)
			st.sendCommand(this.led_on);
		else
			st.sendCommand(this.led_off);
		led = !led;
	}
