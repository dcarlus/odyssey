 ...
 * @param Pointer_Buffer The video data to send.
 ...
 * @warning The maximum ENCRYPTED buffer size that can be sent is defined by macro SECURITY_VIDEO_BUFFER_MAXIMUM_SIZE_BYTES.
 */
